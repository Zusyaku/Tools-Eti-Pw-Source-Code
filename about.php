...
<h2>About this lovely web site</h2>

Date created: 1 march 2014<br />
<br>This website is part of <a href="https://eti.pw" target="_blank">ETI Dev.</a><br />
<br>Not all tools work properly here on this funny host! Sorry!<br />
<br>More working :) tools: <a href="http://brigante.sytes.net/tools" target="_blank">brigante.sytes.net</a><br />
<br>If my web server is UP, then you will be able to see all functionality. But for now server is down :)<br /><br />

<a href="contact.php">Contact</a>
<a href="src.php">Source code</a><br /><br />
...
8.Litecoin: Lc4ERJhALsrDhQJyi3LGECJQJNKqgeh9SZ<br />
9.Please, click on the banners :) pls excuse me for these too many ads in the site ... THANK YOU!<br /><br />
